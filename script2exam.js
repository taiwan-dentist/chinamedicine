...
const questions = [
    ...
    { "type": "填空題", "text": "天台烏藥散", "answers": ["烏藥", "木香", "小茴香", "青皮", "檳榔", "高良薑", "川楝子", "巴豆"] },
    { "type": "填空題", "text": "導氣湯", "answers": ["川楝子", "木香", "小茴香", "吳茱萸"] },
    { "type": "填空題", "text": "橘核丸", "answers": ["橘核", "海藻", "昆布", "海帶", "川楝子", "桃仁", "厚朴", "木通", "枳實", "延胡索", "官桂", "木香"] },
    { "type": "填空題", "text": "金鈴子散", "answers": ["金鈴子", "延胡索"] },
    { "type": "填空題", "text": "延胡索散", "answers": ["延胡索", "當歸", "蒲黃", "赤芍", "肉桂", "片子薑黃", "乳香", "沒藥", "木香", "炙甘草"] },
    { "type": "填空題", "text": "暖肝煎", "answers": ["當歸", "枸杞", "肉桂", "小茴香", "烏藥", "沉香", "茯苓", "生薑"] },
    { "type": "填空題", "text": "旋覆代赭湯", "answers": ["旋覆花", "代赭石", "半夏", "生薑", "人參", "大棗", "甘草"] },
    { "type": "填空題", "text": "橘皮竹茹湯", "answers": ["橘皮", "竹茹", "生薑", "人參", "大棗", "甘草"] },
    { "type": "填空題", "text": "濟生橘皮竹茹湯", "answers": ["赤茯苓", "橘皮", "枇杷葉", "麥門冬", "竹茹", "半夏", "人參", "甘草", "生薑", "大棗"] },
    { "type": "填空題", "text": "新制橘皮竹茹湯", "answers": ["橘皮", "竹茹", "柿蒂", "薑汁"] },
    { "type": "填空題", "text": "丁香柿蒂湯", "answers": ["丁香", "柿蒂", "生薑", "人參"] },
    { "type": "填空題", "text": "奔豚湯", "answers": ["甘李根白皮", "半夏", "黃芩", "葛根", "當歸", "芍藥", "川芎", "生薑", "甘草"] },
    ...
    { "type": "填空題", "text": "厚朴溫中湯", "answers": ["厚朴", "草豆蔻", "乾薑", "陳皮", "木香", "茯苓", "炙甘草", "生薑"] },
    ...
    { "type": "填空題", "text": "回陽救急湯", "answers": ["熟附子", "乾薑", "甘草", "人參", "陳皮", "肉桂", "五味子", "白朮", "茯苓", "半夏", "麝香"] },
    ...
    { "type": "填空題", "text": "當歸四逆加吳茱萸生薑湯", "answers": ["當歸", "桂枝", "芍藥", "細辛", "炙甘草", "通草", "大棗", "吳茱萸", "生薑"] },
    { "type": "填空題", "text": "陽和湯", "answers": ["熟地", "肉桂", "麻黃", "鹿角膠", "白芥子", "薑炭", "生甘草"] },
    { "type": "填空題", "text": "黃耆桂枝五物湯", "answers": ["黃耆", "芍藥", "桂枝", "生薑", "大棗"] },
    { "type": "填空題", "text": "十四味建中湯", "answers": ["半夏", "附子", "肉蓯蓉", "麥冬", "人參", "白朮", "茯苓", "炙甘草", "當歸", "熟地", "白芍", "川芎", "黃耆", "肉桂"] },
    ...
    { "type": "選擇題", "text": "當歸四逆加吳茱萸生薑湯", "answers": ["素體血虛，內有久寒，手足厥寒，脈細欲絕者"] },
    { "type": "選擇題", "text": "陽和湯", "answers": ["陰疽屬於陽虛寒凝證。貼骨疽、脫疽、流注、痰核、鶴膝風。患處漫腫無頭，酸痛無熱，皮色不變，口中不渴，舌苔淡白，脈沉細。"] },
    { "type": "選擇題", "text": "黃耆桂枝五物湯", "answers": ["血痹。陰陽俱微，寸口關上微，尺中小緊，外證身體不仁，如風痹狀。"] },
    { "type": "選擇題", "text": "十四味建中湯", "answers": ["治氣血不足，虛損勞瘠，短氣嗜臥，欲成勞瘵；陰證發斑，寒甚脈微。"] },
